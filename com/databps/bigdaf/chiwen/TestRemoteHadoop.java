...
public class TestRemoteHadoop {
        ...
        URI uri = URI.create("hdfs://192.168.1.128:9000");
...
//        private String homeDir = "/Users/merlin/Documents/software";
        ...
        public void testListStatusNoClose() {
            ...
            try {
                ...
                FileStatus[] fileStatuses = fs.listStatus(new Path("/user9/mytemp"));
        ...
        public void mkdir() {
            ...
            try {
                ...
                boolean fileStatuses = fs.mkdirs(new Path("/user/myself/wowo2/a"));
        ...
        public void testSetAcl() {
            ...
            try {
                UserGroupInformation userGroupInfo =
                        UserGroupInformation.createUserForTesting(USER_NAME, GROUP_NAMES);
                fs = DFSTestUtil.getFileSystemAs(userGroupInfo, uri, conf);
                List<AclEntry> aclSpec = AclEntry.parseAclSpec("user::rwx,user:hdfs1:rwx,user:dr.who:rwx,group::r--,other::---", true);

                fs.setAcl(new Path("/user/myself"), aclSpec);
